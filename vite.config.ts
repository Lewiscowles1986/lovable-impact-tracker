...
// anywhere else __ASSET_BASE_URL__ collapses to an empty string, leaving a
// page-relative "og-image.jpg" reference.
...
export default defineConfig(() => ({
  ...
  // with the repo subpath (e.g. /impact-tracker/) so assets resolve correctly.
